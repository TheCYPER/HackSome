...
from hacksome.core.config import (
    CodexConfig,
...
from hacksome.core.models import CodexTask
...
from hacksome.core.task_executor import (
...
class CreativeIdeaWorkflow:
    ...
    async def resume(self) -> Any:
        ...
        from hacksome.stages.ideation.creative.finalize import CreativeFeedbackFinalizer
    ...
    def _finalize_success(self) -> CreativeRunOutcome:
        ...
        from hacksome.stages.ideation.creative.finalization import (
            FINALIZATION_MANIFEST_PATH,
            FINALIZATION_STAGE,
            FinalizationCoordinator,
            FinalizationError,
        )
        from hacksome.stages.ideation.creative.report import (
            REPORT_MARKDOWN_ARTIFACT_ID,
            render_success_report,
        )
        from hacksome.stages.ideation.creative.report_projection import (
    ...
    def _replay_finalization(self) -> CreativeRunOutcome:
        ...
        from hacksome.stages.ideation.creative.report import REPORT_MARKDOWN_ARTIFACT_ID
    ...
    def _completed_outcome(self) -> CreativeRunOutcome:
        ...
        from hacksome.stages.ideation.creative.report import REPORT_MARKDOWN_ARTIFACT_ID
        from hacksome.core.routes import validate_run

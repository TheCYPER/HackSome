...
LEGACY_CREATIVE_CONTRACT_VERSION = "1"
LEGACY_CREATIVE_PROMPT_POLICY_VERSION = "1"
...
C4_SOFTWARE_DEMO_REVIEW = "creative-software-demo-review"
...
DEFAULT_TERRITORY_LENSES = (
    ...
    "Reversal, reveal, and expectation shifts in a runnable interface",
    "Multiplayer, collaboration, and social propagation",
    "Mystery narratives built from software-visible hidden state",
    (
        "Camera, microphone, text, code, time, or live-data transformation "
        "using ordinary device I/O"
    ),
    (
        "Viral remix, replay, or shareable artifact generated by a technical "
        "mechanism"
    ),
)

SOFTWARE_DEMO_POLICY_FIELDS: Mapping[str, object] = MappingProxyType(
    {
        "schema_version": 2,
...
SOFTWARE_DEMO_POLICY = json.dumps(
    dict(SOFTWARE_DEMO_POLICY_FIELDS),
    ensure_ascii=False,
    sort_keys=True,
    separators=(",", ":"),
)
...
class CrossRunArtifactRef:
    ...
    def __post_init__(self) -> None:
        ...
        if self.source_contract_version not in SUPPORTED_CREATIVE_CONTRACT_VERSIONS:
            raise CreativeContractError(
...
class StableReasonCode(str, Enum):
    ...
    CORE_NOT_SOFTWARE_FIRST = "core_not_software_first"
    ...
    NO_RUNNABLE_END_TO_END_DEMO_PATH = "no_runnable_end_to_end_demo_path"
    ...
    C4_CONCEPT_SCREEN_PASSED = "c4_concept_screen_passed"
    C4_REPAIR_REQUIRED = "c4_repair_required"
    C4_DOUBLE_INVALID = "c4_double_invalid"
    C4_SOFTWARE_DEMO_INVALID = "c4_software_demo_invalid"

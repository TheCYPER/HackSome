...
from hacksome.contracts.post_card.contracts import stable_team_id
from hacksome.core.state import canonical_json_bytes
...
class SubprocessBuildControlAdapter:
    """Fixed-argv pure-JSON boundary to the Build operator module."""
    ...
    def _environment(self) -> dict[str, str]:
        ...
        if (source_root / "hacksome").is_dir():
    ...
    def _call(
        ...
        *,
        ...
        argv = [
            self.build_python,
            "-m",
            "hacksome.stages.build.control.team_operator",
            command,
            "--build-root",
            str(self.build_root),
            "--max-active-teams",

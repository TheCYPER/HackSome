...
The runtime factory lives in hacksome.stages.build.agent_runtime.runtimes (runtime_for) — the spec stays a
...
from hacksome.stages.build.agent_runtime.credentials import CredentialSource
from hacksome.stages.build.agent_runtime.runtimes.base import UNSET, UnsetType
...
def credential_for(spec: AgentSpec) -> CredentialSource:
    ...
    from hacksome.stages.build.agent_runtime.runtimes import runtime_for  # lazy: the spec stays declaration-only at import time

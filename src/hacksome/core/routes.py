...
from hacksome.core.prompting import PromptResourceError, useful_prompt_catalog
...
def _failed_finalization_audit_errors(
    ...
    from hacksome.stages.ideation.creative.finalization import FINALIZATION_STAGE
...
def _validate_success_bundle(
    ...
    from hacksome.stages.ideation.useful.artifacts import ArtifactError, validate_markdown
    from hacksome.stages.ideation.creative.artifacts import FINAL_IDEA_CARD_HEADINGS
    from hacksome.stages.ideation.creative.memory import (
        MemoryRecord,
        MemoryValidationError,
    )

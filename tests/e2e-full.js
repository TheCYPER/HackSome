...
(async () => {
  ...
  assert(cacheKeys.includes("relay-rehearsal-production-20260725-v4") && cacheKeys.every((key) => key === "relay-rehearsal-production-20260725-v4"), "activation removes known stale app caches");

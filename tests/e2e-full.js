...
(async () => {
  ...
  assert(cacheKeys.includes("relay-rehearsal-production-20260725-v6") && cacheKeys.every((key) => key === "relay-rehearsal-production-20260725-v6"), "activation removes known stale app caches");

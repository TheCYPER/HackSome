...
from hacksome.core.state import StateError, atomic_write_json, read_json_object, sha256_text
...
class BuildApprovalStoreTests(unittest.TestCase):
    ...
    def test_existing_approval_open_and_validate_are_read_only(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "hacksome.stages.build.approval.service.project_post_card_catalog",

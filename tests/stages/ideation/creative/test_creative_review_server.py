...
import hacksome.stages.ideation.creative.review_server as review_server_module
...
class TestReviewUIResources(unittest.TestCase):
    def test_fixed_assets_are_packaged_and_use_safe_dynamic_rendering(self) -> None:
        root = resources.files("hacksome.stages.ideation.creative").joinpath("review_ui")

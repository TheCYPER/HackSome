...
from hacksome.stages.ideation.useful.artifacts import validate_markdown
...
from hacksome.stages.ideation.creative.memory import MemoryCapsuleRef, MemoryRecord
